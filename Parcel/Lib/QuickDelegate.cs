// The Beautiful FastDelegate.NET implementation is provided by: coder0xff
...
{
    internal delegate object QuickDelegate(object obj, object[] args);
    internal static class MethodInfoExtensions
    {

        private static QuickDelegate CreateForNonVoidInstanceMethod(MethodInfo method)
        {
            ...
            Expression<QuickDelegate> lambda = Expression.Lambda<QuickDelegate>(
        ...
        public static QuickDelegate Bind(this MethodInfo method)
        {
            if (method.IsStatic)
            {
            ...
            {
                QuickDelegate wrapped = CreateForNonVoidInstanceMethod(method);
                return wrapped;
            }
        }
